        ...
        <div className="grid items-start gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-7">
            <div className="grid gap-4 sm:grid-cols-2">
              <Card className="group relative overflow-hidden border-white/[0.13] bg-white/[0.055] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] sm:col-span-2">
                <div
                  aria-hidden="true"
                ...
                <div className="relative flex items-start justify-between gap-6">
                  <div>
                    ...
                    <p className="text-paper-muted mt-2 max-w-xl text-sm leading-relaxed">
                      Discovery is tuned for people you’ll genuinely want to create
                      with — based on sound, intent, and the way you work.
                    </p>
                  </div>

                  <div className="hidden text-right text-xs text-paper-subtle sm:block">
                    <div className="rounded-full border border-white/[0.12] bg-white/[0.05] px-3 py-1">
                      influence ↔ workflow ↔ goals
                    </div>
                  </div>
                </div>

                <div className="relative mt-5 grid gap-3 rounded-2xl border border-white/[0.12] bg-black/20 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] sm:grid-cols-3">
                  {[
                    ...
                    <div key={i.k}>
                      <div className="text-[11px] text-paper-subtle">{i.k}</div>
                      <div className="text-paper mt-1 text-xs font-medium">
                        {i.v}
                      </div>
                    </div>
                  ))}
                ...
                >
                  ...
                  <div className="relative z-10 mt-4 flex flex-wrap gap-2">
                    {s.chips.map((c) => (
                      <span
                        key={c}
                        className="rounded-full border border-white/[0.12] bg-white/[0.05] px-2.5 py-1 text-[11px] text-paper-muted"
                      >
                        {c}
                      </span>
                    ))}
